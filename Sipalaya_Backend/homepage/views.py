...
from stud_portal.models import EnrolledCourse, CompletedLesson, Assignment, Attendance
from instructor_portal.models import Course as InstructorCourse, Announcement, CourseMaterial
